...
public class WasteSegregationSearch extends AppCompatActivity {
    ...
    private ImageButton bulkyWasteButton;
   ...
   //  @SuppressLint("MissingInflatedId")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bulkyWasteButton = findViewById(R.id.bulkyButton);

        bulkyWasteButton.setOnClickListener(V -> {
            Intent bulkyIntent = new Intent (WasteSegregationSearch.this, ItemBulkyPanel.class);
            startActivity(bulkyIntent);
        });
