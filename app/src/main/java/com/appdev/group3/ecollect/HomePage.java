...
public class HomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        district1Button.setOnClickListener(v -> {
            Intent district1Intent = new Intent(HomePage.this, Dashboard.class);
            startActivity(district1Intent);
        });

        district2Button.setOnClickListener(v -> {
            Intent district2Intent = new Intent(HomePage.this, Dashboard.class);
            startActivity(district2Intent);
        });
    }
}
