...
public class UserProfilePanel extends AppCompatActivity {
    ...
    private void logOutUserProfile() {
        Intent intent = new Intent(UserProfilePanel.this, LogInUser.class);
        startActivity(intent);
    }
    ...
    private void addressDialog() {
        ...
        Button saveAddressButton = addressFormCardView.findViewById(R.id.saveAddressButton);
        Button cancelAddressButton = addressFormCardView.findViewById(R.id.cancelAddressButton);
        ...
        // Handle Cancel button click
        cancelAddressButton.setOnClickListener(v -> {
            // Hide the CardView without saving
            addressFormCardView.setVisibility(View.GONE);
        });
    }
    ...
    private void validateEmail() {
        ...
        String[] validExtensions = {".ph", ".com", ".org", ".edu", ".net", ".gov", ".com.ph", ".org.ph", ".edu.ph", ".net.ph", ".gov.ph"};
